describe("config manager folder-path migration", function()
    ...
    it("loads complete defaults for a fresh install", function()
        ...
        assert.is_true(config.quick_settings.unified_light_slider)
        assert.is_false(config.quick_settings.unified_light_slider_centered)
        assert.is_false(config.quick_settings.tailscale_toggle_wifi)
